...
get "/" do
  ...
  <link rel="stylesheet" type="text/css" href="css/style.css">
  <title>Sinatra - Food Ordering</title>
  </head>
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="inner text-center">
            <h1 class="logo-name">Sumptous</h1>
            <h2>Food To fit your lifestyle & health.</h2>
            <p>Specialized in Ugali Cuisine!!</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-4 col-sm-4 mr-15">
          <div class="media-2">
            ...
            <div class="media-body">
              ...
              <p class="light-blue regular alt-p">+250 784369208 - <span class="contacts-sp">Phone Booking</span></p>
            </div>
          </div>
          <div class="media-2">
            <div class="media-left">
    ...
    <div class="footer-top">
      <div class="row">
        <div class="col-md-offset-3 col-md-6 text-center">
          <div class="widget">
            <h4 class="widget-title">Sumptous</h4>
            <address><br>Kigali, Kg 613</address>
            <div class="social-list">
              <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
              <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            </div>
            <p class="copyright clear-float">
              © Sumptous Theme. All Rights Reserved
              <div class="credits">
              </div>
            </p>
          </div>
